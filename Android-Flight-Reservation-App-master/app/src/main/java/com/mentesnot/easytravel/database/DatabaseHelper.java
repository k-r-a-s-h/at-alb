...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void updateDatabase(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        if (oldVersion < 1) {
            ...
            //toronto to ottawa
            insertFlight(db, "Toronto", "Ottawa", "2019-8-10", "2019-8-10", "10:10", "12:10", 200.00, 1);
            insertFlight(db, "Toronto", "Ottawa", "2019-8-10", "2019-8-10", "10:10", "12:10", 150.00, 2);
            insertFlight(db, "Toronto", "Ottawa", "2019-8-10", "2019-8-10", "11:10", "12:10", 350.00, 3);
            insertFlight(db, "Toronto", "Ottawa", "2019-8-10", "2019-8-10", "09:10", "12:10", 250.00, 4);
            insertFlight(db, "Toronto", "Ottawa", "2019-8-10", "2019-8-10", "10:10", "12:10", 100.00, 5);

            //ottawa to toronto
            insertFlight(db, "Ottawa", "Toronto", "2019-8-12", "2019-8-12", "10:10", "12:10", 120.00, 6);
            insertFlight(db, "Ottawa", "Toronto", "2019-8-12", "2019-8-12", "09:00", "12:10", 150.00, 7);
            insertFlight(db, "Ottawa", "Toronto", "2019-8-12", "2019-8-12", "10:10", "12:10", 170.00, 8);
            insertFlight(db, "Ottawa", "Toronto", "2019-8-12", "2019-8-12", "09:00", "12:10", 140.00, 9);
            insertFlight(db, "Ottawa", "Toronto", "2019-8-12", "2019-8-12", "09:00", "12:10", 100.00, 10);
            insertFlight(db, "Ottawa", "Toronto", "2019-8-12", "2019-8-12", "10:10", "12:10", 350.00, 11);

            //Edmonton to winnipeg
            insertFlight(db, "Edmonton", "Winnipeg", "2019-8-25", "2019-8-25", "02:00", "04:45", 300.00, 2);
            insertFlight(db, "Edmonton", "Winnipeg", "2019-8-25", "2018-8-25", "01:00", "03:15", 205.00, 1);
            insertFlight(db, "Edmonton", "Winnipeg", "2019-8-25", "2019-8-25", "09:00", "12:20", 350.00, 10);
            insertFlight(db, "Edmonton", "Winnipeg", "2019-8-25", "2019-8-25", "08:00", "10:15", 400.00, 11);
            insertFlight(db, "Edmonton", "Winnipeg", "2019-8-25", "2019-8-25", "11:00", "13:11", 250.00, 1);

            //winnipeg to edmonton
            insertFlight(db, "Winnipeg", "Edmonton", "2019-9-15", "2019-9-15", "11:00", "13:11", 300.00, 9);
            insertFlight(db, "Winnipeg", "Edmonton", "2019-9-15", "2019-9-15", "09:00", "12:00", 250.00, 1);
            insertFlight(db, "Winnipeg", "Edmonton", "2019-9-15", "2019-9-15", "08:00", "11:00", 400.00, 3);
            insertFlight(db, "Winnipeg", "Edmonton", "2019-9-15", "2019-9-15", "01:00", "04:00", 150.00, 7);
            insertFlight(db, "Winnipeg", "Edmonton", "2019-9-15", "2019-9-15", "12:00", "14:00", 350.00, 10);


            insertFlight(db, "Montreal", "Edmonton", "2019-7-28", "2019-7-28", "10:10", "12:10", 350.00, 4);
            insertFlight(db, "New York", "Edmonton", "2019-8-15", "2019-8-15", "09:10", "12:10", 185.00, 5);
            insertFlight(db, "Quebec City", "NewYork", "2019-7-28", "2019-7-28", "11:10", "12:10", 250.00, 6);
            insertFlight(db, "Charlottetown", "Victoria", "2019-8-25", "2019-8-25", "10:10", "12:10", 360.00, 7);
            insertFlight(db, "Los Angeles", "Ottawa", "2019-8-26", "2019-8-26", "10:10", "12:10", 350.00, 8);
            insertFlight(db, "Winnipeg", "Toronto", "2019-8-27", "2019-8-27", "09:10", "12:10", 350.00, 9);
            insertFlight(db, "Victoria", "New York", "2019-8-28", "2019-8-28", "10:10", "12:10", 350.00, 10);
